...
export const publicAssets=['racing-loop.mp4','racing-poster.jpg','icra-qualification.mp4','early-robot.jpeg','early-pid.mp4','wro-test.mp4','wro-test-poster.jpg','wro-robot.jpeg','roscon-stage.jpg'];
export function build(){
  ...
  const allowed=new Set([...pages.keys(),'styles.css','app.js','favicon.svg','sitemap.xml','robots.txt','.nojekyll',...publicAssets.map(f=>'assets/'+f)]);
